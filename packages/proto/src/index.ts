...
// Types only — the runtime enum mirrors in `enums.ts` are added when a client first needs
// an E2EE enum *value*, which nothing does while the capability is DISABLED.
export type {
  AcknowledgeEnvelopesRequest,
  AcknowledgeEnvelopesResponse,
  AddE2eeMemberRequest,
  AddE2eeMemberResponse,
  ...
  ListE2eeGroupControlEventsRequest,
