...
| [0040](./0040-realtime-invalidation-stream.md)                        | Realtime is a server-streaming invalidation channel, with unary poll as the mandatory fallback        | Accepted (design)  |
