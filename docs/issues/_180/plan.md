...
This run is gated by the explicit prerequisite `P12-119` (owner sign-off on the
ephemeral Now contract). No implementation is authorized until that gate is
resolved.

- [x] Inspect the live issue, project item, workpad, and repository state.
