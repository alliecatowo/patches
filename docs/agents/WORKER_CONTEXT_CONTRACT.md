...
4,000 characters/80 lines, and caps the whole packet at 32,000 characters. Consecutive duplicate
...
Telemetry may include input/output tokens, transcript bytes, tool calls, wall time, and outcome.
