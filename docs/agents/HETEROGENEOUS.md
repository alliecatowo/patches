...
| **senior-worker / reviewer**            | `gpt-5.6-terra`              | 220k            | $2.00 / $12 / $0.20                                                      | 272k → $4/$18                   | **reasoning: medium-high** — retry after leaf failure, integration, risky review. One retry, then replan or change approach. Only on `blocker=capability`.                                                                                                                                                                            |
