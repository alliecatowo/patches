 ...
 * - Wrapped in `memo` to avoid re-rendering RichBody when parent PostCard or route re-renders.
 * - `useMemo` caches AST output of `parseMarkup(source)` to prevent re-parsing on every render pass.
 */
