/**
 * The web client's end-to-end session runtime — port of the TUI's B-101 module, with
 * the send fanout and the mailbox receive loop implemented over `runtime.ts`'s seams.
 *
