/**
 * Device enrollment (B-107, ADR 0020 §2–§3) — web port of the TUI flow: turns this
 * browser into a real, locally-held messaging device.
 *
 ...
 *      browser (`@noble/curves` — no Node crypto anywhere in this path), then sign
 ...
 *      header; hoisting it into `@patches/domain` is B-124, tracked.
 ...
 *      one-time prekeys, over Connect through `@patches/client`.
 *
