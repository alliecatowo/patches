...
export function PostRow({
  ...
  const mediaItems = getPostMediaAttachments(post);
        ...
        <>
          ...
          {post.deleted ? (
            ...
            <>
              ...
              {mediaItems.length > 0 ? <PostMediaGrid items={mediaItems} /> : null}
            </>
          )}
        </>
      )}
...
function PostMediaGrid({ items }: { items: PostMediaItem[] }): JSX.Element {
  return (
