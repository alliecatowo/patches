...
- **Never document a command you haven't run** (spec §154, CLAUDE.md #7). If you can't run it in this environment (needs secrets, needs a deploy, needs infra not available here), mark it `Status: planned` rather than asserting it works.
